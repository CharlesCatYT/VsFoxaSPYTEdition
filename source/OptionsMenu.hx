...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		new OptionCategory("Gameplay", [
			...
			new MiddlescrollOption("Toggle making the notes be in the center of the screen."),
			new GhostTapOption("Toggle counting pressing a directional input when no arrow is there as a miss."),
			new HitSound("Toggle making sounds play when you hit notes."),
		...
		new OptionCategory("Appearance", [
			...
			new NoteSplashOption("Toggles the notes splashing when you hit a Sick.")]),
