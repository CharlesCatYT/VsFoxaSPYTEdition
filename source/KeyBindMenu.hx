...
class KeyBindMenu extends FlxSubState
{
	...
	override function create()
	{
		...
		keyTextDisplay.setFormat("PhantomMuff 1.5", 42, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		infoText.setFormat("PhantomMuff 1.5", 24, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
