...
class StoryMenuState extends MusicBeatState
{
	...
	static function weekData():Array<Dynamic>
	{
		return [
			/*['Tutorial'],
				...
				['Senpai', 'Roses', 'Thorns'], */
			['Bubbles', 'Burning-Flames', 'Execution', 'Firestorm']
		];
	}
	...
	override function create()
	{
		...
		rankText.setFormat(Paths.font("funkyfont.ttf"), 32);
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			new FlxTimer().start(1, function(tmr:FlxTimer)
			{
				...
				if (curWeek == 0)
				{
					LoadingState.loadAndSwitchState(new VideoState("assets/videos/bubblesCutscene.webm", new PlayState()));
				}
				else
				{
