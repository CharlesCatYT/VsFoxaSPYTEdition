...
class ThanksState extends MusicBeatState
{
	...
	override function create()
	{
		...
		/*var txt:FlxText = new FlxText(0, 0, FlxG.width,
			"Thanks for playing the Vs. Foxa Mod Beta!\nThis took months to make and we hope you enjoy it.\nThis is a Dev "
			+ "\n\nPress Space to continue.",
			32); */
		var txt:FlxText = new FlxText(0, 0, FlxG.width,
			"Thanks for playing the Vs. Foxa Mod!\nYou are on a Playtester Build.\nIf you were given this by someone who isn't either a dev or a beta tester,\nplease contact HenryFlowey#7353 on Discord. " +
