...
class Colour extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.colour ? "Colored Health Bar On" : "Colored Health Bar Off";
	}
}
...
class HitSound extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.hitsounds ? "Hitsounds On" : "Hitsounds Off";
	}
}
...
class MiddlescrollOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.midscroll ? "Middle Scroll On" : "Middle Scroll Off";
	}
}
