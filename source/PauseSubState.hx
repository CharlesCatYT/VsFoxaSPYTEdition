...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItems:Array<String> = ['Resume', 'Restart Song', 'Skip Song', 'Exit to menu']; // debugging stuff for story mode :V
	...
	public function new(x:Float, y:Float)
	{
		...
		levelInfo.setFormat(Paths.font("funkyfont.ttf"), 32);
		...
		levelDifficulty.setFormat(Paths.font('funkyfont.ttf'), 32);
