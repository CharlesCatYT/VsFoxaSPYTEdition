...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'foxa':
				tex = Paths.getSparrowAtlas('foxa', 'shared', true);
				frames = tex;
				...
				playAnim('idle');
			case 'foxa-angy':
				tex = Paths.getSparrowAtlas('angy', 'shared', true);
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 24);
				animation.addByPrefix('singUP', 'Sing Up', 24);
				animation.addByPrefix('singRIGHT', 'Sing Right', 24);
				...
				playAnim('idle');
			case 'foxa-angy-alt':
				tex = Paths.getSparrowAtlas('angy-alt', 'shared', true);
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 24);
				animation.addByPrefix('singUP', 'Sing Up', 24);
				animation.addByPrefix('singRIGHT', 'Sing Right', 24);
				...
				playAnim('idle');
			case 'foxa-mad':
				tex = Paths.getSparrowAtlas('FoxaMad', 'shared', true);
				frames = tex;
				animation.addByPrefix('idle', 'Mad idle dance', 24);
				animation.addByPrefix('singUP', 'Mad Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Mad sing note right', 24);
				animation.addByPrefix('singDOWN', 'Mad Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'Mad Sing Note LEFT', 24);
	...
	public function dance(forced:Bool = false, altAnim:Bool = false)
	{
		if (!debugMode)
		{
			switch (curCharacter)
			{
				case 'gf' | 'gf-christmas' | 'gf-car' | 'gf-pixel' | 'gf-boombox':
